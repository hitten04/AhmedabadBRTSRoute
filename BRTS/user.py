...
class Window_1:
    def __init__(self, master):
        self.master = master
        self.master.title("BRTS Route Finder")
        ...
        self.text_initial_stop = ttk.Combobox(self.Login_Frame_1, values=s.bus_sta, font=('Arial', 16), textvariable=self.initial_stop)
        ...
        self.text_target_stop = ttk.Combobox(self.Login_Frame_1, values=s.bus_sta, font=('Arial', 16), textvariable=self.target_stop)
    ...
    def search(self):
        if self.target_stop.get() == self.initial_stop.get():
            ...
            return
        values = BRTSRoute.search_route(BRTSRoute(), self.initial_stop.get(), self.target_stop.get())
